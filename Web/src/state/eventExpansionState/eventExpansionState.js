import { collapseAll, expandAll, toggleSingleExpanded } from "../activePrimalEvents/activePrimalEventsState";

export const eventExpansionInitialState = {
  allExpanded: true
};

export const allExpandedSelector = (state) => state.primalMagic.eventExpansionState.allExpanded;

const SetAllExpandedStateType = "primalMagic:activePrimalEvents:setAllExpandedState";
